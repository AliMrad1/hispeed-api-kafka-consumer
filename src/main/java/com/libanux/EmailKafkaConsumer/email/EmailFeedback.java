...
import com.libanux.EmailKafkaConsumer.models.Feedback;
import com.libanux.EmailKafkaConsumer.models.ImigrationBody;
import org.apache.commons.lang3.text.WordUtils;

public class EmailFeedback {

    public static String buildEmail(Feedback feedback) {
        ...
        return "<div style=\"font-family:Helvetica,Arial,sans-serif;font-size:16px;margin:0;color:#0b0c0c\">\n" +
            ...
            "                <h1>Contact Us</h1>\n" +
                ...
                "            <p><strong>Service Type:</strong> " + feedback.service_type() + "</p>" +
                "            <p><strong>Messages:</strong> " + feedback.messages() + "</p>" +
